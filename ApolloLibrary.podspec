Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => 'https://github.com/hyperledger-identus/apollo/releases/download/v1.7.2/Apollo.xcframework.zip' }
  spec.vendored_frameworks = 'Apollo.xcframework'
