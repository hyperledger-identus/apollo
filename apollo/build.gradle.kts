...
android {
    ...
    signingConfigs {
        getByName("debug") {
            // Standard Android debug keystore, typically auto-generated by AGP
            // or found in ~/.android/debug.keystore
            // Explicitly defining it here might help CI environments
            // if the default discovery mechanism fails or isn't triggered.
        }
        // If release signing is needed for local publishing or specific repositories,
        // it would be configured here too, likely using environment variables for credentials.
        // Example:
        // create("release") {
        //     storeFile = file(System.getenv("KEYSTORE_FILE") ?: "default.keystore")
    ...
    buildTypes {
        getByName("debug") {
            ...
            // Ensure debug builds are publishable if signAndroidDebugPublication is being called
            // This is often true by default if part of publishLibraryVariants
        }
        getByName("release") {
            // Example if release signing was also being configured:
            // signingConfig = signingConfigs.getByName("release")
            // isMinifyEnabled = false // Or true, with proguard rules
